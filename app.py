...
file_path = "C:/Users/HP/Documents/UM/WIE2003/assignment/model.pkl"
model1 = joblib.load(file_path)
mean1 = np.load("C:/Users/HP/Documents/UM/WIE2003/assignment/mean.npy")
std1 = np.load("C:/Users/HP/Documents/UM/WIE2003/assignment/std.npy")

with st.sidebar:
    selected = option_menu('Rental Price Prediction and Recommendation Website',
...
if(selected == 'Rental Price Prediction'):
    ...
    recommendation_df = pd.read_csv("C:/Users/HP/Documents/UM/WIE2003/assignment/df_final.csv")
...
if selected == 'Rental Market Analysis':
    ...
    df = pd.read_csv("C:/Users/HP/Documents/UM/WIE2003/assignment/cleaned-mudah-apartment-kl-selangor.csv")
